...
def opcoes():
    endereco = endereco_base + "/sendMessage"
    dados = {"chat_id": id_da_conversa, "reply_markup":{"keyboard": [[{"text":"Soar alarme"}],[{"text": "Abrir"}],[{"text": "Ignorar"}]], "one_time_keyboard": True}, "text": "automatica"}
    print("mandei mesnagem automatica")
    resposta = post(endereco, json=dados)
    return
